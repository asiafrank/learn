 ...
 */
public class Q10_RegularExpressionMatching2 {
    ...
    public static void main(String[] args) {
        System.out.println("case1 false: " + isMatch1("aa", "a"));
        System.out.println("case2 true: " + isMatch1("aa", "a*"));
        System.out.println("case3 true: " + isMatch1("aa", ".*"));
        System.out.println("case4 true: " + isMatch1("ab", ".*"));
        System.out.println("case5 true: " + isMatch1("aab", "c*a*b"));
        System.out.println("case5 false: " + isMatch1("mississippi", "mis*is*p*."));
        System.out.println("case6 true: " + isMatch1("mississippi", "mis*is*ip*."));
        System.out.println("case7 true: " + isMatch1("bbbba", ".*a*a"));
    }
}
