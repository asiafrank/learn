...
public class MapFile {
    public static void main(String[] args) throws Exception {
        String prefix = "src/com/ronsoft/books/nio/buffers";

        // Create a temp file and get a channel connected to it
        File tempFile = File.createTempFile(prefix + "mmaptest", null);
        RandomAccessFile file = new RandomAccessFile(tempFile, "rw");
        FileChannel channel = file.getChannel();
        ByteBuffer temp = ByteBuffer.allocate(100);

        // Put something else in the file, starting at location 0
    ...
    public static void showBuffers(ByteBuffer ro,
                                   ByteBuffer rw,
