...
public class Poodle {
    ...
    private static void generateTable(String input, Pattern[] patterns, int[] limits) {
        ...
        for (int i = 0; i < limits.length; i++) {
            int limit = limits[i];
            System.out.println("\t<row>");
            System.out.println("\r\r<entry>Limit: " + limit + "</entry>");
    ...
    /**
     * If command line args were given, compile all args after
     * the first as a Pattern. Return an array of Pattern objects
     */
